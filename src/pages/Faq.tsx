...
function Faq() {
  ...
  return (
    <div
      id="faq"
      className="container w-full mx-auto px-4 md:px-40 flex flex-col items-center justify-center relative py-20 bg-gray-900 dark:bg-white"
    >
      <img
        src={line}
